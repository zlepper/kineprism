...
- Core: `rayon` for deterministic parallel image preparation, alignment-candidate scoring, and independent metric/analysis phases after profiling demonstrated material full-HD improvements.
